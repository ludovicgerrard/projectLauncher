...
public enum DoorVerifyCombination {
    ...
    private DoorVerifyCombination(int i, String str) {
        this(r7, r8, i, str, false);
    }

    private DoorVerifyCombination(int i, String str, boolean z) {
        this.value = i;
    ...
    public static DoorVerifyCombination fromInteger(int i) {
        if (i == 0) {
            return ALL;
        }
        if (i == 1) {
