...
import com.zkteco.edk.yuv.lib.LogTag;
...
public class ZkOpenGLUtils {
    ...
    public static int loadShader(int i, String str) {
        ...
        if (glCreateShader != 0) {
            ...
            Log.e(LogTag.TAG, GLES30.glGetShaderInfoLog(glCreateShader));
    ...
    public static int linkProgram(int i, int i2) {
        ...
        if (glCreateProgram != 0) {
            ...
            Log.v(LogTag.TAG, "Results of linking program:\n" + GLES20.glGetProgramInfoLog(glCreateProgram));
            if (iArr[0] != 0) {
            ...
            Log.e(LogTag.TAG, "Linking of program failed.");
    ...
    public static void createOESTextureObject(int[] iArr) {
        ...
        Log.v(LogTag.TAG, String.format("glGenTextures %s", new Object[]{Integer.valueOf(iArr[0])}));
